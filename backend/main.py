            ...
            for place in places:
                ...
                try:
                    ...
                    combined_for_state_check = " ".join([
                        ...
                        place.get("display_name", "") or "",
                    ]).lower()

                    is_ner = any(
                        ner_state.lower() in combined_for_state_check
                    ...
                    name = (
                        ...
                        or (display_name.split(",")[0] if display_name else display_name)
                        or display_name
                    )
                    ...
                    # Deduplicate using lat/lon rounded and normalized display name
                    key = (
                        round(lat, 6),
                        round(lon, 6),
